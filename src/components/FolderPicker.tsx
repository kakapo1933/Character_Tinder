...
export function FolderPicker({ onFolderSelect }: FolderPickerProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-12">
      ...
      <p className="text-zinc-400 mb-4">Choose a folder with photos to sort</p>
      <button
        onClick={handleOpenPicker}
        className="px-6 py-3 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-colors flex items-center gap-2"
      >
